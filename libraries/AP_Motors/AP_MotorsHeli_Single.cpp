...
AP_Motors::SpoolState AP_MotorsHeli_Single::update_motor_control(AP_Motors::DesiredSpoolState state)
{
    // Send state update to motors
    _tail_rotor.update(static_cast<AP_MotorsHeli_RSC::DesiredSpoolState>(state));
