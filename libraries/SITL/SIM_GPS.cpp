...
void GPS::update()
{
    ...
    d.altitude = altitude + params.noise * sinf(gps_wander_angle_rad) + params.alt_offset;
    ...
    d.latitude += glitch_offsets.x +  params.noise_radius * sinf(gps_wander_angle_rad) * 1.113195e-5;
    d.longitude += glitch_offsets.y + params.noise_radius * cosf(gps_wander_angle_rad) * 1.113195e-5;
